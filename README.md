...
**Intel GPUs:** PyTorch XPU acceleration is supported for Intel Arc (including Battlemage B-series such as B580). FP16 is enabled by default. ONNX can use DirectML on Windows. NCNN (Vulkan) is also supported.
